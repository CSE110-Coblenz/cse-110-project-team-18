...
export class MercuryGameModel {
    ...
    private view: MercuryGameView; // display questions, results, and summary windows
    ...
    */
	...
	public async run(): Promise<void> {
		while (this.questionCount < this.maxNumberOfQuestions) {
			this.view.displayQuestion(this.questionCount, this.questionsBank[this.questionCount].text);
		...
		this.view.displaySummary(this.correctAnswers, this.maxNumberOfQuestions, this.minNumberOfQuestionsToWin);
	}
...
const mercury = new MercuryGameModel();
mercury.run();
